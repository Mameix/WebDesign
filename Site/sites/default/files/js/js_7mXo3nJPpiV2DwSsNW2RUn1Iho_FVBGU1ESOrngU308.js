...
(function ($, Drupal) {
  ...
  Drupal.behaviors.upjv = {
    attach: function (context, settings) {
		...
		const onglet2 = chemin[chemin.length-2];
		const page2 = chemin[chemin.length-1];
		console.log("<div><img alt=\""+page2+"\" class=\"w-100 mx-auto imgOffre\" src=\"/themes/upjv/img/"+onglet2+"/"+page2+".png\" /></div>");
		$('#bandeau').innerHTML = "<div><img alt=\""+page2+"\" class=\"w-100 mx-auto imgOffre\" src=\"/themes/upjv/img/"+onglet2+"/"+page2+".png\" /></div>"
    }
  };
